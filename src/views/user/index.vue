<template>
  <el-main>
    ...
    <el-table :height="tableHeight" :data="tableList" border stripe>
      ...
      <el-table-column label="超级管理员" prop="isAdmin">
        <!-- 作用域插槽 -->
        <template #default="scope">
          <el-tag v-if="scope.row.isAdmin == '1'" type="primary" size="default"
            >是</el-tag
          >
          <el-tag type="danger" v-else size="default">否</el-tag>
        </template>
      </el-table-column>
    ...
    <!-- 分配菜单 -->
    <AssignTree ref="assignRef"></AssignTree>
  </el-main>
</template>
...
//新增、编辑、删除
const { addBtn, editBtn, deleteBtn, addUserRef, assignBtn, assignRef } =
  useUser(getList);
</script>
