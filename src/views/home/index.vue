<template>
  <el-main :style="{ height: mianHeight + 'px' }">
    ...
    >
      <el-col :span="6">
        <div class="show-header" style="background: rgb(225, 205, 205)">
          <div class="show-num">{{ reisterCount }}</div>
          <div class="bottom-text">注册总数</div>
        </div>
      </el-col>
      <el-col :span="6">
        <div class="show-header" style="background: rgb(251, 251, 179)">
          <div class="show-num">{{ memberCount }}</div>
          <div class="bottom-text">社员总数</div>
        </div>
      </el-col>
      <el-col :span="6">
        <div class="show-header" style="background: rgb(193, 193, 188)">
          <div class="show-num">{{ categoryCount }}</div>
          <div class="bottom-text">分类总数</div>
        </div>
      </el-col>
      <el-col :span="6">
        <div class="show-header" style="background: rgb(88, 82, 72)">
    ...
    <div style="display: flex">
      <el-card style="flex: 1">
        <template #header>
          <div class="card-header">
            <span style="color: #00c0ef50;font-weight: 600;">热门社团</span>
          </div>
        </template>
        <div :style="{ width: '400px', height: '250px' }">
          <div v-for="(item,index) in hotList" class="item text">
            ...
            <span style="margin-left: 10px"
              ><span style="color: #ff767050">{{ item['value'] }}</span>人参与</span
            >
      ...
      <el-card style="margin-left: 20px; flex: 1">
        <template #header>
          <div class="card-header">
            <span style="color: #00c0ef50;font-weight: 600;">热门活动</span>
          </div>
        </template>
        <div :style="{ width: '400px', height: '250px' }">
          <div>
            <div v-for="(item,index) in hotActivity" class="item text">
              <span style="font-weight: 600; font-size: 14px">{{ item['name'] }}</span>
              <span style="margin-left: 10px"
                ><span style="color: #ff767050">{{ item['value'] }}</span>人报名</span
              >
              <el-divider class="drive"></el-divider>
            </div>
          </div>
      ...
      <el-card style="margin-left: 20px; flex: 1">
        <template #header>
          <div class="card-header">
            <span style="color: #00c0ef50;font-weight: 600;">男女比例</span>
          </div>
        </template>
