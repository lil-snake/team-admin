    ...
    <el-table :height="tableHeight" :data="tableList" border stripe>
      ...
      <el-table-column prop="sex" label="性别">
        <template #default="scope">
          <el-tag v-if="scope.row.sex == '0'" type="danger" size="default"
            >男</el-tag
          >
      ...
      <el-table-column align="center" width="420" label="操作">
        <template #default="scope">
          ...
          <el-button
            ...
            type="warning"
            size="default"
            @click="resetPasswotdBtn(scope.row)"
            >重置密码</el-button
          >
          <el-button
            icon="Edit"
...
const { searchParm, getList, searchBtn, resetBtn, tableList,sizeChange,currentChange,tableHeight } =
  useMemberTable();
//增删改业务
const { stopBtn, resetPasswotdBtn, deleteBtn ,startBtn} = useMember(getList);
</script>
